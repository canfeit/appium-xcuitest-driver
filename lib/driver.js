...
class XCUITestDriver extends BaseDriver {
  ...
  async installAUT () {
    ...
    if (this.isRealDevice()) {
      await installToRealDevice(this, this.opts.device, this.opts.app, this.opts.bundleId, this.opts.noReset);
    } else {
